...
export const TestimonialsSection = () => {
  ...
  return (
    <section style={{
      ...
      {/* Bottom Row - 3 Testimonials in Single Row */}
      <div style={{ 
        maxWidth: '1200px', 
        margin: '40px auto 0',
        display: 'grid',
        ...
        {/* Testimonial 5 - Michael Carter - Vertical Card */}
        <div style={{
          background: '#FFFFFF',
          borderRadius: '16px',
          padding: '30px',
          ...
          <div style={{ display: 'flex', gap: '15px', alignItems: 'center' }}>
            ...
            <div>
              ...
              <div style={{
                ...
                fontSize: '14px',
                color: '#999999'
              }}>Blue River Landscaping</div>
            </div>
          </div>
        </div>

        {/* Testimonial 6 - Rachel Sanders - Vertical Card */}
        <div style={{
          background: '#FFFFFF',
          borderRadius: '16px',
          padding: '30px',
          ...
          <div style={{ display: 'flex', gap: '15px', alignItems: 'center' }}>
            ...
            <div>
              ...
              <div style={{
                ...
                fontSize: '14px',
                color: '#999999'
              }}>Sweet Crumbs Bakery</div>
            </div>
          </div>
        </div>

        {/* Testimonial 7 - Megan Thompson - Vertical Card */}
        <div style={{
          background: '#FFFFFF',
          borderRadius: '16px',
          padding: '30px',
